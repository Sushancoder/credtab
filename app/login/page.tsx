            ...
            <div className="w-full max-w-sm space-y-8">
                ...
                <div className="border border-border rounded-xl p-6 space-y-4 bg-card shadow-sm">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 border border-border rounded-lg px-4 py-2.5 text-sm font-medium bg-background hover:bg-muted transition-colors cursor-pointer"
                    >
                        {/* Google SVG Icon */}
